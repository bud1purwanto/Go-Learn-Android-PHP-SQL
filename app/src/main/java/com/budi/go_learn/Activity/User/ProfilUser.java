...
public class ProfilUser extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        if (view == btnEditProfile) {
            ...
            if(bitmap == null){
                editProfileWP(name, phone, email, address, gender);
            }else{
                editProfile(name, phone, email, address, gender);
            }
            getImage();
        }
    ...
    private void editProfile(final String name, final String phone, final String email,
        ...
        class editProfile extends AsyncTask<Bitmap,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ProfilUser.this,"Editing...","Please Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Snackbar mySnackbar = Snackbar.make(findViewById(R.id.profil_user),
                        s, Snackbar.LENGTH_LONG);
                mySnackbar.show();
//                Toast.makeText(ProfilUser.this,s,Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(Bitmap... params) {
                ...
                data.put(User.KEY_NAME, name);
                data.put(User.KEY_PHONE, phone);
                data.put(User.KEY_EMAIL, email);
                data.put(User.KEY_ADDRESS, address);
                data.put(User.KEY_GENDER, gender);
                data.put(User.KEY_FOTO, uploadImage);

                String result = rh.sendPostRequest(Konfigurasi.URL_EDITPROFIL_USER , data);
                return result;
            }
        }
...
//                Toast.makeText(ProfilUser.this,s,Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(Void... params) {
                ...
                String result = rh.sendPostRequest(Konfigurasi.URL_EDITPROFIL_USERWP , data);
                return result;
            }
        }
